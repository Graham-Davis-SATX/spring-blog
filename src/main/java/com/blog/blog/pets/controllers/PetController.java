...
//        viewModel.addAttribute("pets", petDao.findAll());
//        return "pets/all-pets";
//    }
//
//    @GetMapping("/pets/{id}")
//    public String index(@PathVariable long id, Model viewModel) {
//        viewModel.addAttribute("pet", petDao.findOne(id));
//        return "pets/show-pet";
//    }
//
//    @GetMapping("/pets/{id}/details/create")
//    private String createPetDetails(@PathVariable long id, Model viewModel) {
//        viewModel.addAttribute("id", id);
//        viewModel.addAttribute("petDetail", new PetDetail());
